enyo.kind({
	name: "quantum.WarrantFilterSettingsPopup",
	kind: "quantum.Popup",
			...
			{name: "filterSettingsScroller", kind: "enyo.Scroller", style: "margin-top: 15px; width: 800px; height: 600px; background-color: #FFFFFF; color: black; padding: 10px;", components: [
				...
				{kind: "enyo.FittableColumns", style: "padding-top: 5px;" , components: [
					...
					{style: "margin-left: 20px;", components: [
						{kind:"quantum.Checkbox", name:"newCheckbox", content:"New", columnStyle:"margin-top: 10px;", contentStyle:"margin-left:10px;", onchange: "onStatusCheckedChange"},
						...
						{kind:"quantum.Checkbox", name:"pendingTransactionCheckbox", content:"Active - Pending Transaction", columnStyle:"margin-top: 10px;", contentStyle:"margin-left:10px;", onchange: "onStatusCheckedChange"},
					]},
					{style: "margin-left: 20px;", components: [
						...
						{kind:"quantum.Checkbox", name:"splitCheckbox", content:"Split", columnStyle:"margin-top: 10px;", contentStyle:"margin-left:10px;", onchange: "onStatusCheckedChange"},
				...
				{kind: "enyo.FittableColumns", style: "padding-top: 5px;" , components: [
					{components: [
						{kind:"quantum.Checkbox", name:"onlyRootWarrantsCheckbox", content:"Only Root Warrants", columnStyle:"margin-top: 10px;", contentStyle:"margin-left:10px;"}
					]}
				]}
			]},
