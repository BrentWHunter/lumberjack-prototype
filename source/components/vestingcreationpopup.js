enyo.kind({
	name: "quantum.VestingCreationPopup",
	kind: "quantum.Popup",
	...
	subComponents: [
		{style: "height 400px; padding: 10px;", components: [
			...
			{name: "vestingConditionScroller", kind: "enyo.Scroller", style: "margin-top: 15px; width: 560px; height: 170px; background-color: #EEEEEE;", components: [
				{name: "conditionTypeInput", type:"text", columnStyle:"margin-top: 10px;", labelStyle:"line-height: 38px; width: 170px; color:black; padding-left:10px;", decoratorStyle: "margin-left: 10px; width: 350px;", inputStyle: "width: 100%;", kind:"quantum.Input", readonly:true, required:true, disabled:true, value:"Event", label: "Condition Type:"},
				{name: "conditionNameInput", type:"text", columnStyle:"margin-top: 10px;", labelStyle:"line-height: 38px; width: 170px; color:black; padding-left:10px;", decoratorStyle: "margin-left: 10px; width: 350px;", inputStyle: "width: 100%;", kind:"quantum.Input", required:true, label: "Condition Name:"},
				{name: "conditionDescriptionInput", type:"text", columnStyle:"margin-top: 10px;", labelStyle:"line-height: 38px; width: 170px; color:black; padding-left:10px;", decoratorStyle: "margin-left: 10px; width: 350px;", inputStyle: "width: 100%;", kind:"quantum.Input", required:true, label:"Condition Description:"}
			]},
			{style: "text-align: center; margin-top: 15px;", components: [
				...
				{name: "newConditionButton", kind: "quantum.Button", content: $L("Add Condition"), style: "margin-left: 10px; width: 150px; height: 40px;", ontap: "newConditionButtonTapped"}
			]}
		]},
