enyo.kind({
	name: "lumberjack.OptionFilterSettingsPopup",
			...
			{name: "filterSettingsScroller", kind: "enyo.Scroller", style: "margin-top: 15px; width: 800px; height: 600px; background-color: #FFFFFF; color: black; padding: 10px;", components: [
				...
				{kind: "enyo.FittableColumns", style: "padding-top: 5px;" , components: [
					...
					{style: "margin-left: 20px;", components: [
						{kind:"lumberjack.Checkbox", name:"newCheckbox", content:"Created", columnStyle:"margin-top: 10px;", contentStyle:"margin-left:10px;", onchange: "onStatusCheckedChange"},
					...
					{style: "margin-left: 20px;", components: [
						...
						{kind:"lumberjack.Checkbox", name:"cancelledCheckbox", content:"Cancelled", columnStyle:"margin-top: 10px;", contentStyle:"margin-left:10px;", onchange: "onStatusCheckedChange"}
					]}
				]}
			]},
